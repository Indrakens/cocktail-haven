...
urlpatterns = [
    ...
    path('edit_cocktail/<slug:slug>',
         views.RecipeUpdate.as_view(), name='edit_cocktail'),
    path('delete_cocktail/<slug:slug>',
         views.RecipeDelete.as_view(), name='delete_cocktail'),
